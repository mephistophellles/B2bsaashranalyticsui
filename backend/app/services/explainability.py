...
def recommendation_expected_effect(source: str, audience: str = "manager") -> str:
    ...
    if source == "ml":
        return "Стабилизация состояния и улучшение показателей; снижение доли сотрудников в зоне риска."
    return "Стабилизация состояния и улучшение показателей; снижение управленческих рисков по отделу."
...
def _problem_cause_action(
    *,
    ...
    problem = (
        "Текущие условия создают риск снижения эффективности."
        if audience == "manager"
